...
![Horse populations for all provinces in Canada from 1906 - 1972.](docs/results/horse_pops_plot.png){#fig-horse_pop width=67%}
...
![Horse populations for the province with the largest standard deviation](docs/results/horse_pops_plot_largest_sd.png){#fig-horse_dev width=67%}


In @fig-horse_dev we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
